    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-950 via-gray-900 to-black text-gray-200 p-6">
      <Card className="max-w-2xl w-full border-emerald-900/40 bg-gray-900/90 backdrop-blur">
        ...
        <CardContent className="text-gray-300 space-y-3">
          <p>Few have seen Karandras move—fewer still knew they were watched. Half-elf roots, elven patience; the forest itself holds its breath when he passes. På denne underside kan du skrive længere lore eller historiske events.</p>
        </CardContent>
      </Card>
    </div>
  );
